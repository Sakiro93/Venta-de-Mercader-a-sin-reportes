...
Public Class Man_Categoria
    ...
    Public Sub cargar(ByVal Buscar As String)
        Dg.Rows.Clear()
        For Each cat In Logicadatos.buscarCat(CBOpcion.SelectedIndex, Buscar)
            Dg.Rows.Add(cat.cat_ID, cat.cat_Descripcion)
        Next
    End Sub
    Public Sub limpiar()
        ErrDatos.Clear()
    ...
    Private Sub Man_Categoria_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        limpiar()
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        Dim datos = New EntCategoria(Cod, TxtDescripcion.Text)
